...
When NVIDIA decided to open source part of their driver, it caused a lot of commotion. Except, it wasn't open source. Not to my definition, anyway. NVIDIA said they wouldn't allow pull requests or changes to the code. While the codebase was online, free to view and copy, it didn't foster the community that I associate with open source.